...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {	
		Integer valorInt;
		try {
			valorInt = Integer.parseInt(ReservasView.txtValor.getText());
			...
			Reserva reserva = new Reserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS),valorInt, ReservasView.txtFormaPago.getSelectedItem().toString());
			reservasController.guardar(reserva);
			Date dateE = ReservasView.txtFechaE.getDate();
			Date dateS = ReservasView.txtFechaS.getDate();
			Integer DiasReservados = Math.round((dateS.getTime() - dateE.getTime()) / 86400000);
			if (DiasReservados<=0) {
